...
```
- 반복문을 통한 객체 배열의 각 원소의 면적 출력
```cpp
return 0;
```
- 0을 반환하고 메인함수 종료
# 실행결과
<img width="803" height="392" alt="스크린샷 2026-04-03 000509" src="https://github.com/user-attachments/assets/6691ded4-1594-48b0-9278-0ab2770b3cf2" />
